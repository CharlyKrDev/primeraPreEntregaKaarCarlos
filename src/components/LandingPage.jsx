    ...
    <>
      <main className='bg-black'>
        ...
        <section className='md:flex justify-center sm:h-[54.5vh] h-full ml-6'>
          ...
          <picture className='flex flex-col w-[60%] m-auto items-center pb-20'><img className='bg-white max-h-[55vh] m-auto' srcSet={Portada} src='https://firebasestorage.googleapis.com/v0/b/proyecto-final-kaar-carlos.appspot.com/o/portada.jpg?alt=media&token=329158ec-4a7d-462b-a052-a8877e95a756' alt="portada" /></picture>
        </section>
