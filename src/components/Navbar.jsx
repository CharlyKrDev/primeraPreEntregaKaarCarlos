    ...
    return (
        ...
        <header className='bg-black font-bold text-white'>
            ...
            <nav className='flex justify-between items-center w-[99%] mx-auto'>
                <a className='flex gap-1 items-center justify-center ml-5' href="#"><img className='w-16 mt-0.5 invert' src="/public/eCommerce.svg" alt="logo" /><img className='w-16 mr-2' src="/public/logo.jpg" alt="logo" /></a>
