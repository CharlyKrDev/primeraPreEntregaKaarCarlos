    ...
    <section className="bg-[#242424] flex border-2 m-auto my-2 w-[100%] j">
      ...
      <div className="flex sm:h-[50%] m-auto items-center justify-center space-x-2 w-[100%]">
                <button
                  ...
                  onClick={() => {decrementarContador(); agregarProducto(prod, (contador == 1?contador: contador-1)) }}
                >
                  -
                </button>
        ...
        <p className="w-[100%] text-lg semi-bold text-center mx-2">Subtotal: ${precioTotal}</p>
      </div>
